            ...
            <div class="col">
                ...
                <div class="container">
                    <form action="proses.php" method="POST">
                        ...
                        <a href="buat_pelanggan.php" class="btn btn-primary">Buat Pelanggan Baru</a><br>
                        <a href="laporan_inventori_admin.php" class="btn btn-primary">Laporan Inventori</a><br>
